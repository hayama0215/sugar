...
　ＤＸライブラリ Windows版 VisualStudio( C++ )用(Ver3.24f)

・開発に使用した開発環境のバージョン
  Used Development Environment
  　Visual Studio 2020 Professional  Version 17.13.6
-----------------------------------------------------------------------------
 どうしてそのプログラムを作ろうと思いましたか？
 Why did you create this program?
-----------------------------------------------------------------------------
　好きなYouTubeゲーム配信者がレースゲームをしていて、自分も作って見たいと思ったから。

-----------------------------------------------------------------------------
 プログラムを作成する上で注意した事は？
 What were you careful about?
-----------------------------------------------------------------------------
　制作期間が空いても直ぐに戻れるようにコードが長くなり過ぎない、わかりやすく書くこと。
　途中で新しく面白いアイデアなどが出たらなるべく取り入れるようにする。

-----------------------------------------------------------------------------
 プログラムを作成する上で大変だった所は？
 What did you find difficult?
-----------------------------------------------------------------------------
　カメラを２個同時処理することと、そのカメラを使うための２画面分割。
　プレイヤー同士が当たった時の跳ね返り設定。
　モデルを制作すること。
...
-----------------------------------------------------------------------------
　レースゲームを実現するための逆走などが出来ないようにするコースの設定。
　各々のアイテムっ設定
